package com.clientv1.amnclientv1.security.services;
...
import com.clientv1.amnclientv1.security.repository.RefreshTokenRepository;
...
public class RefreshTokenService {
    ...
    @Value("${amn.app.jwtRefreshExpirationMs}")
